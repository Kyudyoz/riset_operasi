...
def optimize_and_aljabar_max(a_values, c_values):
    ...
    # display_optimization_result_max(x_optimal, z_optimal)
...
def optimize_and_aljabar_min(a_values, c_values):
    ...
    # Menampilkan hasil optimasi ke jendela terpisah
    # display_optimization_result_min(x_optimal, z_optimal)
    result_window = tk.Toplevel()
    result_window.title("Hasil Optimasi")
...
# def display_optimization_result_max(x_optimal, z_optimal):
#     global result_window 
#     result_window = tk.Toplevel()
#     result_window.title("Hasil Optimasi")
...
# # Fungsi untuk menampilkan hasil optimasi dalam jendela terpisah
# def display_optimization_result_min(x_optimal, z_optimal):
#     global result_window 
#     result_window = tk.Toplevel()
#     result_window.title("Hasil Optimasi")
